...
[![godoc](http://img.shields.io/badge/godoc-reference-blue.svg?style=flat)](https://godoc.org/github.com/gocommon/zerolog) [![license](http://img.shields.io/badge/license-MIT-red.svg?style=flat)](https://raw.githubusercontent.com/rs/zerolog/master/LICENSE) [![Build Status](https://travis-ci.org/rs/zerolog.svg?branch=master)](https://travis-ci.org/rs/zerolog) [![Coverage](http://gocover.io/_badge/github.com/gocommon/zerolog)](http://gocover.io/github.com/gocommon/zerolog)
...
```go
import "github.com/gocommon/zerolog/log"
```
...
NOTE: To import the global logger, import the `log` subpackage `github.com/gocommon/zerolog/log`.
...
The `github.com/gocommon/zerolog/hlog` package provides some helpers to integrate zerolog with `http.Handler`.
